...
const RedirectToLogin = React.lazy(() => import('../pages/common/RedirectToLogin'));
...
const ComponentsDemo = React.lazy(() => import('../pages/common/ComponentsDemo'));
...
const Discussions = React.lazy(() => import('../pages/wrappers/DiscussionsPage'));
...
export const routes = [
  ...
  },
  {
    path: '/tasks',
    element: Tasks,
    meta: { title: 'Tasks', protected: true, roles: ['STAFF', 'STUDENT', 'TEACHER'] },
  },
  {
    path: '/reports',
    element: Reports,
    meta: { title: 'Reports', protected: true, roles: ['STAFF', 'STUDENT', 'TEACHER'] },
  },
  {
    path: '/progress',
    element: Progress,
    meta: { title: 'Progress', protected: true, roles: ['STAFF', 'STUDENT', 'TEACHER'] },
  },
  {
    path: '/discussions',
    element: Discussions,
    meta: { title: 'Discussions', protected: true, roles: ['STUDENT', 'TEACHER'] },
  },
  {
    path: '/schedule',
    element: Schedule,
    meta: { title: 'Schedule', protected: true, roles: ['STUDENT', 'TEACHER'] },
  },
  {
    path: '/ai',
    element: AiAssistant,
